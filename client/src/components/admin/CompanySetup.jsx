...
const CompanySetup = () => {
    ...
    const fetchCompanyData = async () => {
        try {
            const res = await axios.get(`https://your-api-endpoint.com/company/${params.id}`, {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            const res = await axios.put(`https://your-api-endpoint.com/update/${params.id}`, formData, {
                headers: {
